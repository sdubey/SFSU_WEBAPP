  ...
  <div id="container">
    ...
    <table border="1.0" width="100%">
      <tr>
        ...
        </select> <br> Date of meeting <input type="date" name="meeting_date"
          id="meeting_date"><br>
        </td>
        <td>This is recording a (Check one):<br> <input
    ...
    <table border="1.0" width="100%">
      <tr>
        <td>
          <p>For Meeting only: Number of team members absent in the team</p>
        </td>
    ...
    <table border="1.0" width="100%">
      <tr>
        <td>
          <table>
            <tr>
              <td>Checkpoints<br> <a href="checkpoints"> Create/
                  Update / View existing check point</a></td>
            </tr>
          </table>
